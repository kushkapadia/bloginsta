...
//insaed of using nodes syntax of modules.export we used to export default (As it is latest and greatest )
...
sendRequest(){
   ...
   // a is a url we want to send the request to. B is the object with any data we want to send along to the server
}
