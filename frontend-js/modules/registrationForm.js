...
if(el.previousValue!=el.value){
 handler.call(this)
 //call will run this function and it will make sure that the this keyword is whatever we set it to.
}
...
this.showValidationError(this.username, "Username must be atleast be 3 charachters.")
}
...
passwordAfterDelay(){
    if(this.password.value.length < 12){
        this.showValidationError(this.password, "Password must be must least 12 characters.")
    }
}
